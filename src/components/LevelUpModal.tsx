...
export function LevelUpModal({ isOpen, onClose, player, onUpdate }: LevelUpModalProps) {
  ...
  // Ajout pour la modal sous-classe
  ...
  // Ouvre le modal sous-classe quand nécessaire
  useEffect(() => {
