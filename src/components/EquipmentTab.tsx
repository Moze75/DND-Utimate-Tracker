...
export function EquipmentTab({
  ...
  // Paramètres depuis slot (armure/bouclier) - CORRECTION: Passer lockType
  const openEditFromSlot = (slot: 'armor' | 'shield') => {
    ...
    if (item) {
      // Ajouter une propriété temporaire lockType pour identifier que l'objet vient d'un slot
      setEditingItem({ ...item, lockType: true } as any);
    }
  };
