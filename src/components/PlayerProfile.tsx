...
export function PlayerProfile({ player, onUpdate }: PlayerProfileProps) {
  ...
  style={{ gridTemplateColumns: 'auto 8rem' }}  // la 1re colonne s’adapte au contenu
>
  <div className="relative mx-auto w-[clamp(12rem,40vw,22rem)] aspect-[2/3] rounded-lg overflow-hidden bg-gray-800/50 flex items-center justify-center">
    <button
